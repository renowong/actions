...
{
	this.daylist = new Array('Dim','Lun','Mar','Mer','Jeu','Ven','Sam','Dim','Lun','Mar','Mer','Jeu','Ven','Sam'); /*<lang:en>*/
	this.months_sh = new Array('Janvier','Fevrier','Mars','Avril','Mai','Juin','Juillet','Aout','Septembre','Octobre','Novembre','Decembre');
	this.monthup_title = 'Aller au mois suivant';
	this.monthdn_title = 'Aller au mois precedant';
	this.clearbtn_caption = 'Effacer';
	this.clearbtn_title = 'Effacer toutes les dates selectionnees';
	this.maxrange_caption = 'Vous etes a la date maximale';
};
//-----------------------------------------------------------------------------
...
Date.prototype.dateFormat = function(format)
{
	...
	var MONTH_NAMES = new Array('Janvier','Fevrier','Mars','Avril','Mai','Juin','Juillet','Aout','Septembre','Octobre','Novembre','Decembre','Jan','Fev','Mar','Avr','Mai','Jui','Juil','Aou','Sep','Oct','Nov','Dec');
